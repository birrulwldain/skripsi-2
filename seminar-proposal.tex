...
% Di file utama:
\documentclass{jifproposal-abdul}  % Ganti dari jifproposal-abdul
...
\usepackage{tocloft}
\newcommand{\listofappendices}{\listof{appendices}{Daftar Lampiran}}
...
\usepackage{amsfonts}  % atau \usepackage{amssymb}
...
% Command dibawah ini bertujuan untuk membuat nomor halaman berada di tengah lalu halaman selanjutnya di kanan
\pagestyle{fancy}
\fancyhf{}
\fancyfoot[R]{\thepage}
