...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{simulasi_spektrum_emisi.png} % Ganti dengan path ke gambar simulasi spektrum emisi
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{diagram_grotrian_ndyag.png} % Ganti dengan path ke gambar diagram Grotrian Nd:YAG
    \caption{Diagram Grotrian Nd:YAG}
    \label{fig:diagram_grotrian_ndyag}
\end{figure}
...
\paragraph{Mekanisme \textit{pumping} dan proses relaksasi non-radiatif.}
